...
describe('Parse Local ISO Dates and Times', () => {
  ...
  describe('parse and format dates', () => {
    let d = '20130108';
    ...
    expect(new DateTime(d).valueOf()).toBe(new Date(Date.UTC(2018, 4, 2, 11, 12, 13)).valueOf()); // not recommend
  });

  describe('String ISO 8601 date, time and zone', () => {
    const time = '2018-04-04T16:00:00.000Z'
    expect(new DateTime(time).valueOf()).toBe(new Date(Date.UTC(2018, 3, 4, 16)).valueOf())
  });

  describe('String en-US Locale date, time and zone', () => {
    const time = '04/04/2018 04:00:00 PM'
    expect(new DateTime(time).valueOf()).toBe(new Date(2018, 3, 4, 16).valueOf())
  });

	describe('Arrays with time part', () => {
  ...
  describe('parses Arrays with date part', () => {
    ...
    const expected = '2018-05-01T00:00:00.000-04:00';
		...
		expect(dateTime.valueOf()).toBe(new Date(2018, 4, 1).valueOf());
  });

  describe('parses millisecond up to 9 digits', () => {
  ...
  describe('String Other, Undefined and Null and isValid', () => {
...
describe('Clone not affect each other', () => {
...
describe('Clone with same value', () => {
